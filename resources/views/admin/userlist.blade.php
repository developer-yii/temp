                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="basic-datatable-preview">
                                <table id="user_datatable" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            <td colspan="7"><button id="delete-selected" class="btn btn-danger">Delete
                                                    Selected</button></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th width="5%">Suggest in Invite?</th>
                                            @if (Auth::user()->canAssignAdminRoles())
                                                <th width="10%">Role</th>
                                            @endif
                                            <th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('admin.user.update') }}" class="pl-3 pr-3 edit-form"
                        id="edit-form">
                        @csrf
...
@section('js')
    <script>
        ...
        var suggestUserUrl = "{{ route('admin.user-suggestable-update') }}";
        var roleUpdateUrl = "{{ route('admin.user-role-update') }}";
        var ROLE_SUPER_ADMIN = {{ App\Models\User::ROLE_SUPER_ADMIN }};
        var ROLE_ADMIN = {{ App\Models\User::ROLE_ADMIN }};
        var ROLE_USER = {{ App\Models\User::ROLE_USER }};
        var canAssignRoles = {{ Auth::user()->canAssignAdminRoles() ? 'true' : 'false' }};
    </script>
