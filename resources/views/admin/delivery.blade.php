            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <h5 class="modal-title"><span id="exampleModalLabel">Add Delivery</span>
                     ...
                     <form method="POST" action="{{ route('admin.delivery.addupdate') }}" class="pl-3 pr-3 add-form" id="add-form">
                        @csrf
                        <input type="hidden" name="id" id="update-id">

                        <div class="form-group">
                           <label for="delivery_message">Delivery Message<span class="text-danger">*</span></label>
                           <div class="form-input">
                                <textarea id="delivery_message" name="delivery_message" class="form-control @error('delivery_message') is-invalid @enderror" rows="5"></textarea>
