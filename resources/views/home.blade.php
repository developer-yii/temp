        ...
        <div class="panel-body" id="createmessage">
            <form action="" method="post" id="message-form" autocomplete="off">
                ...
                <div class="form-group">
                    <textarea name="note" id="note" class="form-control form-message" rows="8" maxlength="10000"
    ...
    <div class="panel-body" id="createurl" style="display: none;">
        ...
        <div class="well">
            <div class="input-group" id="clipboardjs-group" style=""><b>URL</b>
                <input type="text" class="form-control form-url-normal clipboardjs" name="noteurl1" id="noteurl1"
                    data-clipboard-target="#noteurl1" autocomplete="off" readonly>
                ...
                <form action="" method="post" id="image-store" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="choose-file">Choose File : <span class="mandatory">*</span></label>
                                </div>
